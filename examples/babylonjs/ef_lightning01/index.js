...
function main() {
  ...
  let t = 0;
  scene.registerBeforeRender(() => { t += 0.01; cube.rotation.y = t; });
  ...
  effekseer.initRuntime("../../effekseer/effekseer-webgl.wasm", () => {
    ...
    scene.registerAfterRender(() => {
      ...
      const pos = cam.position, target = cam.target;
      context.update(1);
      context.setProjectionPerspective(cam.fov * (180 / Math.PI), canvas.width / canvas.height, cam.minZ, cam.maxZ);
